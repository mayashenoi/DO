...
Optimise the inventory levels across plants, distribution centers and retailers using [cplex.](https://github.com/mayashenoi/DO/blob/main/DIO_InventoryOptimization_CplexV2.ipynb) \
\
\
